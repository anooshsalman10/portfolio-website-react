    ...
    >
      ...
      <div className="container mx-auto px-6">
        <h2 className='text-3xl font-bold text-center mb-4'>My
          <span className='text-purple-500 mx-2'>Journey</span>
        </h2>
        <p className='text-gray-400 text-center max-w-2xl mx-auto mb-16'>My journey in the professional world so far</p>
                ...
                <div key={index} className="relative pl-12 before:content-[''] before:absolute before:left-0 before:top-0 before:w-[2px] before:h-full before:bg-purple-500 cursor-pointer hover:-translate-y-2 transition-all duration-300" >
                  ...
                  <div className='bg-dark-300 rounded-2xl p-6'>
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className='px-3 py-1 bg-purple-400 text-purple-800 rounded-full text-xs md:text-sm '>{data.duration}</span>
                    </div>
